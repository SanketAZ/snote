...
public class JwtAuthConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    private Collection<? extends GrantedAuthority> extractRoles(Jwt jwt) {
        ...
        if (resourceAccess != null && resourceAccess.containsKey("snote-application")) {
            Map<String, Object> demoAccess = (Map<String, Object>) resourceAccess.get("snote-application");
